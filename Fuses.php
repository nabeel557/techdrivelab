...
<div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-1.jpg);">
    <div class="container-fluid page-header-inner py-5">
        <div class="container text-center">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Fuses</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center text-uppercase">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Pages</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Fuses</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="text-primary text-uppercase">FUSES</h1>
            <h1 class="mb-5"></h1>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/fuses 1.jpg" alt="">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="fw-bold mb-0">Blade Fuses</h5>
                        <small> Commonly used in modern vehicles for low to medium current circuits lower current.</small>
                    </div>
                </div>
            </div>

            <!-- Repeat similar structure for other fuse items -->
            <!-- Example for another fuse -->
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/fuses 2.jpg" alt="">
                        <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1 add-to-favorites" data-id="fuse2" href="#"><i class="fas fa-heart"></i></a>
                            <a class="btn btn-square mx-1" href="#" data-bs-toggle="modal" data-bs-target="#cartModal" id="cartBtn"><i class="fas fa-shopping-cart"></i></a>
                        </div>
                    </div>
                    <div class="bg-light text-center p-4">
                        <h5 class="fw-bold mb-0">Mini Blade Fuses</h5>
                        <small>A smaller version of blade fuses, used in compact spaces for circuits with lower current.</small>
                    </div>
                </div>
            </div>

            <!-- Add more fuse items here following the same structure -->
            <!-- Additional items can be added similarly -->

            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/fuses 3.jpg" alt="">
                        <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1 add-to-favorites" data-id="fuse2" href="#"><i class="fas fa-heart"></i></a>
                            <a class="btn btn-square mx-1" href="#" data-bs-toggle="modal" data-bs-target="#cartModal" id="cartBtn"><i class="fas fa-shopping-cart"></i></a>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" src="img/fuses 4.jpg" alt="">
                        <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1 add-to-favorites" data-id="fuse2" href="#"><i class="fas fa-heart"></i></a>
                            <a class="btn btn-square mx-1" href="#" data-bs-toggle="modal" data-bs-target="#cartModal" id="cartBtn"><i class="fas fa-shopping-cart"></i></a>
                        </div>
