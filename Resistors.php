...
<div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-1.jpg);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Resistors</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Resistors</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="text-primary text-uppercase">Resistors</h1>
                <h1 class="mb-5"></h1>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            ...
                            <a class="btn btn-square mx-1 add-to-favorites" href=""><i class="fas fa-heart"></i></a>
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Variable Resistor</h5>
                            <small>Adjusts resistance to control voltage and current levels.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Wirewound Resistor</h5>
                            <small> Handles high power with minimal heat generation, stable performance performance.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Carbon Film Resistor</h5>
                            <small> Offers good stability and low noise for general applications.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/image 6.jpg" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1 add-to-favorites" href=""><i class="fas fa-heart"></i></a>
                            <a class="btn btn-square mx-1" href="" data-bs-toggle="modal" data-bs-target="#cartModal" id="cartBtn"><i class="fas fa-shopping-cart"></i></a>
                            </div>
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Metal Film Resistor</h5>
                            <small>Provides high precision and low temperature coefficient</small>
                        </div>
                    </div>
                </div>
            </div>
