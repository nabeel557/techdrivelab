...
<div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-1.jpg);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Capacitors</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Capacitors</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="text-primary text-uppercase">Capacitors</h1>
                <h1 class="mb-5"></h1>
            </div>
        ...
        transform: translateY(0);
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/capaciator 1.jpg" alt="">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">AudioControl DQ-61</h5>
                            <small>Optimizes audio signals, enhancing clarity and volume in systems.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/capaciator 2.jpg" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1 add-to-favorites" data-id="fuse1" href="#"><i class="fas fa-heart"></i></a>
                            <a class="btn btn-square mx-1" href="#" data-bs-toggle="modal" data-bs-target="#cartModal" id="cartBtn"><i class="fas fa-shopping-cart"></i></a>
                            </div>
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Stinger SPV70</h5>
                            <small>Provides rapid power delivery, minimizing voltage drop for amplifiers.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/capaciator 4.jpg" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1 add-to-favorites" data-id="fuse1" href="#"><i class="fas fa-heart"></i></a>
                            <a class="btn btn-square mx-1" href="#" data-bs-toggle="modal" data-bs-target="#cartModal" id="cartBtn"><i class="fas fa-shopping-cart"></i></a>
                            </div>
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Rockford Fosgate RFC1</h5>
                            <small>Compact capacitor improving bass response and reducing audio distortion.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.15s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="img/capaciator 8.jpeg" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <a class="btn btn-square mx-1 add-to-favorites" data-id="fuse1" href="#"><i class="fas fa-heart"></i></a>
                            <a class="btn btn-square mx-1" href="#" data-bs-toggle="modal" data-bs-target="#cartModal" id="cartBtn"><i class="fas fa-shopping-cart"></i></a>
                            </div>
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Dyno-Boost Capacitor</h5>
                            <small>Boosts electrical stability, improving sound quality and amplifier efficiency.</small>
